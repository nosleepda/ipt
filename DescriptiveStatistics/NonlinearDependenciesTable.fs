...
module NonlinearDependenciesTable =
...
//        | 2 -> funcRegressionFive
    ...
    let F a =
        ...
        String.Format("Уравнение нелин. регрессии статистически {0}значимо, \nт.к. {1} {2} {3}", bool, l, bool2, r )
    
    let nu =
        sqrt ((wysmy2 / n) / (pymy2 / n))
    
    let draw1 =
        Graphic2.Plotly.draw2LineAndMark xTitle ys xfs yfs
        
    let draw2 =
        Graphic2.Plotly.draw2Resize xTitle ys xTitle fxs 1700 800